...
export default function Home() {
    // --- State Management ---
    const [lang, setLang] = useState<'en' | 'es'>('en'); // Estado para el idioma
    const t = translations[lang]; // Objeto de traducciones actual
        ...
        try {
            ...
            if (finalPayload.status === 'success') {
                ...
                if (res.ok && data.success) {
                    ...
                    throw new Error(data.detail || "La verificación falló en el backend.");
                }
            } else {
