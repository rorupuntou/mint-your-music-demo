...
contract DeployScript is Script {
    function run() external returns (MintYourMusicNFT) {
        address myWallet = 0x536bB672A282df8c89DDA57E79423cC505750E52; // <-- REPLACE with your wallet address

        // Official WLD Token Address on World Chain Mainnet
